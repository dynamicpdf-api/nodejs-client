...
export class PageInput extends Input {
    ...
    get Width() {
        return this.PageWidth !== undefined ? this.PageWidth : DefaultPageWidth;
    }

    get Height() {
        return this.PageHeight !== undefined ? this.PageHeight : DefaultPageHeight;
    }
    ...
    set PageOrientation(value) {
        ...
        if(this.Width > this.Height){
            this.#smaller = this.Height
            this.#larger = this.Width
        }else{
            this.#smaller = this.Width
            this.#larger = this.Height
        }
