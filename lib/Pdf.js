...
export class Pdf extends Endpoint {
    ...
    */
    addHtml(resource, basePath = null, pageSize = PageSize.A4, orientation = Orientation.portrait, margins) {
    ...
    * @param {number} margins for all four sides
    */
    addWord(resource, pageSize = PageSize.A4, orientation = Orientation.portrait, margins) {
    ...
    * @param {number} margins for all four sides
    */
    addExcel(resource, pageSize = PageSize.A4, orientation = Orientation.portrait, margins) {
