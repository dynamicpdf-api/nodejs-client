...
export class Pdf extends Endpoint {
    ...
    */
    addHtml(resource, basePath = null, pageSize = PageSize.Letter, orientation = Orientation.portrait, margins) {
        var input = new HtmlInput(resource, basePath, pageSize, orientation, margins);
        this.inputs.push(input);
        return input;
    }
