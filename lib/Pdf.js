...
export class Pdf extends Endpoint {
    ...
    {    
        ...
        if(addResource.Type == resourceType.layoutData)
            ...
            this._finalResources.push(addResource);
    }
    ...
    dlexAdditionalResourceWithBytes(resourceData, additionResourceType, resourceName) {
        ...
        switch (additionResourceType) {
            ...
            case 'Pdf':
                ...
                break;
            case 'Html':
                type = additionalResourceType.Html;
                break;
            default:
        ...
        this._finalResources.push(resource);
    }
     ...
     * @returns PageInput 
     */
    addPage(size, orientation, margins){
		var input;
        if ((typeof (size) === "string" || size == null) && ( typeof (orientation) === "number" || orientation == null)) {
    ...
    */
    ...
    async process() {
        ...
        this.#pdfInstructions.inputs.forEach((input) => {
            if (input._Type == inputType.page) {
                input.elements.forEach((element) => {
                    ...
                    if (element.textFont != null && element.textFont.resourceName != null) {
                        this.#pdfInstructions.fonts.set(element.textFont.resourceName,element.textFont);
                    }
                });
            }
            ...
            if (input.template) {
                this.#pdfInstructions.templates.set(input.template.id, input.template);
        ...
        this._finalResources.forEach((resource) => {
            finalResources.push(resource);
        });
