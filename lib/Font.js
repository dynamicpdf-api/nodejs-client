    ...
    static init() {
        try {
            ...
            if (platform === "win32") {
                ...
                const fontPath = path.join(windir, "Fonts");

                if (fs.existsSync(fontPath) && fs.statSync(fontPath).isDirectory()) {
                    this.pathToFontsResourceDirectory = fontPath;
                }
            }
            ...
            // -------- macOS --------
                ...
                const paths = [
                    ...
                    "/Library/Fonts",
                    home ? path.join(home, "Library", "Fonts") : null
                ];

                for (const p of paths) {
                    if (p && fs.existsSync(p) && fs.statSync(p).isDirectory()) {
                        this.pathToFontsResourceDirectory = p;
                        break;
                    }
                }
            }
            ...
            console.error("Error in getting the font:", e);
        }
    }
